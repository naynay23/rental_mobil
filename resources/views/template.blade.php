  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="http://localhost:8000/merk">Merk Mobil</a></li>
        <li><a href="http://localhost:8000/mobil">Daftar Mobil</a></li>
        <li><a href="http://localhost:8000/pelanggan">Data Pelanggan</a></li>
